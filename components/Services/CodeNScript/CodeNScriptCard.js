"use client";
import { Share2, Play, Monitor, Smartphone } from "lucide-react";
  ...
  const shareProduct = async () => {
    if (navigator.share) {
      await navigator.share({
        ...
        url: `https://www.yoursite.com/services/codeNscript/${product.slug}`,
      });
    } else {
          ...
          <div className="flex justify-between items-center flex-col w-full *:w-full *:flex *:justify-between *:items-center space-y-1">
            <div>
              ...
              <p className="text-2xl font-black text-white">
                {loading
                  ? "......."
                  : convertINR(product.basePrice?.toLocaleString()) || 0}
              </p>
            </div>
            <div className="text-right">
              ...
              <p className="text-sm font-bold text-slate-300">
                ...
                {loading
                  ? "......."
                  : convertINR(
                      Object.values(product.additionalCharges)
                        .reduce((a, b) => a + b, 0)
                        .toLocaleString()
                    ) || 0}
              </p>
